...
<main class="container d-flex justify-content-center align-items-center vh-100">
    ...
    <form method="POST" action="/centro/usuario/updateUser" class=" bg-warning bg-opacity-50 d-flex flex-column justify-content-center w-100 h-75 px-5 py-4 rounded" >
        ...
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-auto">
                <a href="/centro/usuario/deleteUser" class="btn btn-danger">Eliminar</a>
            </div>
            <div class="col-auto">
